  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-primary-700 mb-6">Terms and Conditions</h1>
        <div className="bg-white p-8 rounded-lg shadow-sm prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-3">Subscription period</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3">Subscription cancellations</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-3">Your Right to Post Content</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3">Content Backups</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-3">Intellectual Property Infringement</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h3>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">For European Union (EU) Users</h2>
            <p className="text-gray-600">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">United States Federal Government End Use Provisions</h2>
            <p className="text-gray-600">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">United States Legal Compliance</h2>
            <p className="text-gray-600">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Translation Interpretation</h2>
            <p className="text-gray-600">
