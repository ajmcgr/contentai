    ...
    <div className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-8">
          <div>
            <h3 className="text-xl font-reckless font-medium mb-2">How does the scheduling work?</h3>
          ...
          <div>
            <h3 className="text-xl font-reckless font-medium mb-2">Which platforms do you support?</h3>
          ...
          <div>
            <h3 className="text-xl font-reckless font-medium mb-2">Can I try it for free?</h3>
