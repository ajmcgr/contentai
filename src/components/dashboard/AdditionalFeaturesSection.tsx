      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-reckless font-medium mb-2">Write in your language</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-reckless font-medium mb-2">Edit article with AI</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-reckless font-medium mb-2">Generate unlimited keywords</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-reckless font-medium mb-2">Multi-site package</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-reckless font-medium mb-2">Multi-user access</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-reckless font-medium mb-2">Support</h3>
