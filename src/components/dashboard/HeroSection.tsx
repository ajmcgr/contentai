  ...
  return (
    <div className="py-16 md:py-28 bg-white">
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        <h2 className="text-4xl md:text-6xl font-reckless font-medium text-center mb-4 text-black" style={{ letterSpacing: '1px' }}>
          Generate Professional Press Releases in Minutes, Not Hours
        </h2>
