  ...
  return (
    <div className="py-16 md:py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        <h2 className="text-3xl md:text-4xl font-reckless font-medium text-center mb-12 md:mb-16">How It Works</h2>
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          <div className="text-center">
            ...
            <h3 className="text-xl md:text-2xl font-reckless font-medium mb-3 md:mb-4">1. Deep Business Analysis</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl md:text-2xl font-reckless font-medium mb-3 md:mb-4">2. 30-Day Content Plan</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl md:text-2xl font-reckless font-medium mb-3 md:mb-4">3. Automated Publishing</h3>
