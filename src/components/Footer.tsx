    ...
    <footer className="bg-white border-t">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-medium text-foreground mb-4 text-base">Company</h3>
          ...
          <div>
            <h3 className="font-medium text-foreground mb-4 text-base">Support</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-medium text-foreground mb-4 text-base">Free Tools</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-medium text-foreground mb-4 text-base">Connect</h3>
            <ul className="space-y-2">
